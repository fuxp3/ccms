	...
	<HEAD>
		...
		<script type="text/javascript">
			function addCategory(){
				window.location.href = "${pageContext.request.contextPath}/addCategoryjsp";
			}
		</script>
	</HEAD>
	<body>
					...
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<tr
									style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; HEIGHT: 25px; BACKGROUND-COLOR: #E6E6E6">
								...
								<c:forEach items="${cate}" var="c" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/modifyCategoryjsp?cid=${c.cid}">
													<img src="${pageContext.request.contextPath}/img/admin/i_edit.gif" border="0" style="CURSOR: hand">
												</a>
											</td>
									
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/deleteCategory?cid=${c.cid }" class="deleteCategory">
