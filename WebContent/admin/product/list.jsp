...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			function addProduct(){
				window.location.href = "${pageContext.request.contextPath}/addProductjsp";
			}
		</script>
	</HEAD>
	<body>
					...
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<tr style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; HEIGHT: 25px; BACKGROUND-COLOR: #E6E6E6">
								...
								<c:forEach items="${page.list}" var="p" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/modefyProductjsp?pid=${p.pid}">
											...
											<td align="center" style="HEIGHT: 22px">
												<%--下架 pushdown --%>
												<a href="${pageContext.request.contextPath}/addDownProduct?pid=${p.pid}&curPage=1" class="addDownProduct">
